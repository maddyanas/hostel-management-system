...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
     ...
     if(isset($_POST['name']) && isset($_POST['regno']) && isset($_POST['email']) && isset($_POST['phoneno']) && isset($_POST['password']) && isset($_POST['confirmpassword']) && isset($_POST['gender']) && isset($_POST['roomsharing']) ){
   ...
   if(!preg_match($nameregex, $name)){
     ...
     session_start();
     $sql = "INSERT INTO `users` (`name`, `regno`, `email`, `phoneno`, `password`, `gender`, `roomsharing`, `block`) VALUES ('$name', '$regno', '$email', '$phoneno', '$password', '$gender', '$roomsharing', NULL)";
    ...
    <div class="content">
      <form action=""   method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">roomsharing</span>
            <input type="text" placeholder="Enter your number" name="roomsharing" value="<?php echo "$roomsharing"; ?>" pattern="[0-9]{1}" required>
          </div>
