...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  include 'C:\xampp\htdocs\admin\header.php';?>
...
if ($conn->connect_error) {
    die("Connection failed: " . $conn->connect_error);
      ...
      function approve() {
        ...
        $regno1=$_POST['id'];
        $sql1="UPDATE `guest` SET `status`='approved' where regno='$regno1'";
      ...
      function reject() {
        ...
        $regno1=$_POST['id'];
        echo $regno1;
        $sql1="UPDATE `guest` SET `status`='rejected' where regno='$regno1'";
        $query1=mysqli_query($conn,$sql1);
        if($query1){
...
<?php } ?>
  ...
  <?php
    ...
    <div>
      <a href="sample1.html"><button class="mb-[20px] w-[200px] rounded-md bg-[#1d77f5] py-[8px] text-[14px] font-semibold text-white shadow-[0px_0px_0px_2px_rgba(25,113,238,1),inset_0px_1px_1px_0px_rgba(255,255,255,0.3)] [text-shadow:_0_1px_0_rgb(0_0_0_/_20%)]">Continue</button></a>
    </div>
</div>
  </body>
</html>
