...
function room_allo(){
  window.location.href ="room_allo.php";
}
...
function booking(){
  window.location.href ="../adminguest.php";
}
</script>
  </head>
  <body>
...
<div class="wrapper">
   ...
   <div class="content">
      ...
      <div class="card" onclick="room_allo()">

<div class="icon"><i class="material-icons md-36" >search</i></div>
<p class="title">Room allocation</p>
<p class="text">Check all student room number</p>
      ...
      <div class="card" onclick="booking()">

            <div class="icon"><i class="material-icons md-36">description</i></div>
            <p class="title">Guest Room Booking</p>
            <p class="text">Approve or reject booking requests.</p>
